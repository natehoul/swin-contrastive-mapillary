...
from video_swin.mmaction.datasets.pipelines import RandomRescale, RandomScale, Resize
from video_swin.mmaction.datasets.pipelines.augmentations import PoseCompact
