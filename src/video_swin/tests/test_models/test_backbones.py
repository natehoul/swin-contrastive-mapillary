...
from video_swin.mmaction.models import (C3D, X3D, MobileNetV2TSM, ResNet2Plus1d,
                             ResNet3dCSN, ResNet3dSlowFast, ResNet3dSlowOnly,
                             ResNetAudio, ResNetTIN, ResNetTSM, TANet)
from video_swin.mmaction.models.backbones.resnet_tsm import NL3DWrapper
...
def test_resnet_tsm_backbone():
    ...
    from video_swin.mmaction.models.backbones.resnet import Bottleneck
    from video_swin.mmaction.models.backbones.resnet_tsm import TemporalShift
...
def test_mobilenetv2_tsm_backbone():
    ...
    from video_swin.mmaction.models.backbones.resnet_tsm import TemporalShift
    from video_swin.mmaction.models.backbones.mobilenet_v2 import InvertedResidual
...
def test_tanet_backbone():
    ...
    from video_swin.mmaction.models.backbones.resnet import Bottleneck
    from video_swin.mmaction.models.backbones.tanet import TABlock
...
def test_resnet_tin_backbone():
    ...
    from video_swin.mmaction.models.backbones.resnet_tin import (CombineNet,
                                                      TemporalInterlace)
