...
from video_swin.mmaction.datasets import build_dataloader, build_dataset
from video_swin.mmaction.models import build_model
from video_swin.mmaction.utils import register_module_hooks

# TODO import test functions from mmcv and delete them from video_swin.mmaction2
try:
    from mmcv.engine import multi_gpu_test, single_gpu_test
except (ImportError, ModuleNotFoundError):
    warnings.warn(
        'DeprecationWarning: single_gpu_test, multi_gpu_test, '
        'collect_results_cpu, collect_results_gpu from video_swin.mmaction2 will be '
        'deprecated. Please install mmcv through master branch.')
    from video_swin.mmaction.apis import multi_gpu_test, single_gpu_test
